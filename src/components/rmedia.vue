<template>
  <div data-version="1.0.0" data-loadurl="http://assets.wenweipo.com/software/RMedia1.0.0x64.zip">
    <h1>RMedia1.0.0操作介绍</h1>
    <h2>目录</h2>
    <tree-detail :tree="tree"></tree-detail>
    <section>
      <h2 id="s1">操作流程概述</h2>
      <article>
        <h3 id="s1a1">主要流程：</h3>
        <p>批量输入文件 --> 点击【开始】按钮直接压缩处理。</p>
      </article>
      <article>
        <h3 id="s1a2">中间可选流程：</h3>
        <p>设置参数、批量设置（即全局调控）、设置输出目录。默认的输出目录是桌面，需要特别注意覆盖文件行为。</p>
      </article>
      <article>
        <h3 id="s1a3">一些操作按钮介绍</h3>
        <p><img class="float-r margin-l" src="../assets/rmedia/img/00.jpg" alt=""></p>
        <p>菜单栏的滑杆：控制视图大小。</p>
    ...
    <hr>
    <section>
      <h2 id="s2">参数面板介绍（结合部分处理种类）</h2>

      <article>
        <h3 id="s2a1"># 1.视频压缩</h3>
        <img class="float-r margin-l" src="../assets/rmedia/img/01.jpg" alt="参数图">
        <p><b>主要参数：</b></p>
      ...
      <article>
        <h3 id="s2a2"># 2.视频、音频截取片段</h3>
        <img class="float-r margin-l" src="../assets/rmedia/img/02.jpg" alt="参数图">
        <p><b>主要参数：</b></p>
      ...
      <article>
        <h3 id="s2a4"># 4.logo添加</h3>
        <img class="float-r margin-l" src="../assets/rmedia/img/04.jpg">
        <p>
      ...
      <article>
        <h3 id="s2a6"># 6.序列图转gif动图或视频</h3>
        <img class="float-r margin-l" src="../assets/rmedia/img/06.jpg">
    ...
    <hr>
    <section>
      <h2 id="s3">全局参数面板介绍</h2>
      <article id="s3a1">
        <img class="float-r margin-l" src="../assets/rmedia/img/07.jpg" alt="">
    ...
    <section>
      <h2 id="s4">更多功能介绍</h2>
      <article>
        <h3 id="s4a1"># 1.屏幕录制</h3>
        <img class="float-r margin-l" src="../assets/rmedia/img/m01.jpg" alt="">
        <ol>
          <li>
            <h4>录制模式</h4>
            <ul>
      ...
      <article>
        <h3 id="s4a2"># 2.PDF转图片</h3>
        <p>进入新的操作界面，有以下按钮如图。</p>
      ...
      <article>
        <h3 id="s4a3"># 3.图片拼接</h3>
        <img src="../assets/rmedia/img/m05.jpg" alt="">
